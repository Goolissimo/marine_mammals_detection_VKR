...
# Определяем классы
class_labels = {"dolphin": 0, "whale": 1} # Change/add more for your database

# Определяем директорию
input_dir = 'labeled_data/United' 
output_dir = 'yolo3' 

# Определяем процент разделения
split_ratio = 0.2 # 20% of the data will go to the validation set

# Создаём выходную директорию, если отсутствует
os.makedirs(output_dir, exist_ok=True)

# Создаём директории для тренировочных и валидационных данных
...
# Переносим изображения в тренировочную и валидационную директории
